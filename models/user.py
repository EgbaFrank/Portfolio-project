...
class User(BaseModel, Base):
    ...
    if getenv("GH_STORAGE_TYPE") == "db":
        ...
        def shop_lists(self):
            ...
            return [shop_list for shop_list in shop_lists.values() if shop_list.id in self.shop_list_ids]
        ...
        def shop_lists(self, value):
            ...
            if isinstance(value, Shop_list):
                if value.id not in self.shop_list_ids:
                    ...
                    self.shop_list_ids.extend([shop_list.id for shop_list in value
